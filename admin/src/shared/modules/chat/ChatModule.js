...
const ChatModule = ({ scope = "admin", roomId = "admin-room" }) => {
                          ...
                          <div className="ct_chat_list_grid">
                            ...
                            <div className="flex-grow-1 ms-1">
                              <div className="d-flex align-items-center gap-2 mb-1 ">
                                ...
                                {isNewChat
                         ? null : <span className=" ct_fs_10 text-dark text-capitalize ">
                                  ({item?.type})
                                </span>}
                                   {!isActiveConversation && item?.lastMessageAt && item.unreadCount > 0 ? (
                  ...
                  <div className="d-block">
                    ...
                    <div className="send-box p-0">
                      <form onSubmit={handleSubmit} className="position-relative">
                        ...
                        <button
                          type="submit"
                          className="ct_right_side_send_chat_btns justify-content-end  border-0 text-dark"
                        >
