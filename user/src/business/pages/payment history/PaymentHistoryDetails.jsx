...
const PaymentHistoryDetails = () => {
  ...
  const user = { name: "Payment History Details", role: "guestBusiness" };
    ...
    <PanelLayout user={user}>
      <div className="row ">
        <div className="col-md-12">
          {payHisData?.is_canceled != "No" && (
            <div className="ct_light_orange_alert mb-4">
              ...
              <div>
                <h5 className="ct_fs_18 ct_fw_700 mb-2">Cancelletion Reason</h5>
        ...
        <div className=" text-end ">
          ...
          >
            <i className="fa-regular fa-file-lines me-2"></i> Download Invoice
          </a>
        </div>
        ...
        <div className="col-md-8 mt-4">
          <div className="ct_dash_light_blue_bg p-4 mt-4 h-100">
            <div className="d-flex align-items-center justify-content-between mb-4 ct_flex_col_575 gap-2">
              <h4 className="ct_fs_20 ct_fw_600 ">Property Details</h4>
              <p
                className={`mb-0 ct_border_radius_10 ${
            ...
            <div className="row align-items-center">
              ...
              <div className="col-md-8 mb-4 mb-md-0">
                ...
                {/* <ul className="ct_mt_40 ct_grid_dash_2">
                  <li>
                    <p className="d-flex align-items-center gap-2 mb-1 ct_upcoming_clr">
                      <img  loading="lazy"
                        src="https://app.flexsirent.com/assets/img/clock_green_icon.svg"
                        alt=""
                      />
                      Booked On
                    </p>
                    <p className=" mb-0 ct_upcoming_clr ">10 March, 2024</p>
                  </li>
                  <li>
                    <p className="d-flex align-items-center gap-2 mb-1 ct_upcoming_clr">
                      <img  loading="lazy"
                        src="https://app.flexsirent.com/assets/img/calander_green_icon.svg"
                        alt=""
                      />
                      Check-In
                    </p>
                    <p className=" mb-0 ct_upcoming_clr">
                ...
                <div className="mt-md-auto mt-4">
                  <a
                    ...
                    onClick={(e) => {
                      e.preventDefault(e);
                      navigate(businessPath?.BusinessPropertyDetails, {
        ...
        <div className="col-md-4 mt-4">
          <div className="ct_dash_light_blue_bg p-4  mt-4 h-100">
            <h4 className="ct_fs_20 ct_fw_600 ">Payment Details</h4>
            <ul>
              <li className="d-flex align-items-center justify-content-between pt-3">
                <p className="ct_fs_16 ct_fw_600 mb-0">Security Deposit:</p>
              ...
              <li className="d-flex align-items-center justify-content-between pt-3">
                <p className="ct_fs_16 ct_fw_600 mb-0">Monthly Rent:</p>
                <p className="ct_fs_16 mb-0 ct_white_nowrap">
                  {curSym}
               ...
               <li className="d-flex align-items-center justify-content-between pt-3">
                <p className="ct_fs_16 ct_fw_600 mb-0">Discount:</p>
              ...
              <li className="d-flex align-items-center justify-content-between pt-3">
                <p className="ct_fs_16 ct_fw_600 mb-0">Total Amount:</p>
                <p className="ct_fs_16 mb-0 ct_white_nowrap">
                  {curSym}
      ...
      <div className="row ct_mt_30 pt-4">
        <div className="col-md-12 mt-4">
          {/* <ul className="ct_payments_month_list">
            <li>
              <img  loading="lazy"
                src="https://app.flexsirent.com/assets/img/orange_check_active.png"
                alt=""
              />
              <span className="ct_orange_text">1st Month</span>
            </li>
            <li>
              <img  loading="lazy"
                src="https://app.flexsirent.com/assets/img/orange_check_active.png"
                alt=""
              />
              <span className="">2nd Month</span>
            </li>
            <li>
              <img  loading="lazy"
                src="https://app.flexsirent.com/assets/img/check_without_active.png"
                alt=""
              />
              <span className="">3rd Month</span>
            </li>
            <li>
              <img  loading="lazy"
                src="https://app.flexsirent.com/assets/img/check_without_active.png"
          ...
          <div className="pb-4 mb-4 ct_border_btm_grey">
            <div className="d-flex align-items-center justify-content-between gap-3 mb-3 ct_flex_col_575">
              <h4 className="ct_fs_20 ct_fw_600 mb-0">Transaction Details</h4>
            ...
            <div className="mt-4">
              <div className="table-responsive mt-3 ct_custom_table">
                <table className="table ">
                  <TableHeader data={payementHisDetailTableHeader} />
                          ...
                          {/* <td>
                            <div className="d-flex align-items-center gap-3 justify-content-end">
                              <a
                                ...
                                data-bs-target="#ct_payment_detail"
                                className="text-dark"
                              >
