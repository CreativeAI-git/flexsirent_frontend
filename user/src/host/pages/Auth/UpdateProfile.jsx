...
import { updateHostProfileSchema } from "../../../shared/utils/schema";
...
const UpdateProfile = () => {
  ...
  const user = { name: "Edit Profile", role: "host" };
  ...
  const initialValues = {
    ...
    owner_type: state?.data?.owner_type ?? "1",
      ...
      <div className="row">
        <div className="col-md-12">
          <Formik
            ...
            validationSchema={updateHostProfileSchema}
                    ...
                    <div className=" row">
                      <div className="col-md-6">
                        <div className="form-group mb-4">
                          <label className="ct_fw_500 mb-2">First Name</label>
                          <input
                            type="text"
                      ...
                      <div className="col-md-6">
                        <div className="form-group mb-4">
                          <label className="ct_fw_500 mb-2">Last Name</label>
                          <input
                            type="text"
                      ...
                      <div className="col-md-12">
                        <div className="form-group mb-4">
                          <label className="ct_fw_500 mb-2 ">Are you a</label>
                          <select
                            name="owner_type"
