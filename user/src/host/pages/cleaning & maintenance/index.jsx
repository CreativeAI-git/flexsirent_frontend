...
const CleaningMaintenance = () => {
  ...
  const user = { name: "Cleaning & Maintenance", role: "host" };
                ...
                paginatedList?.map((item, index) => (
                  <tr key={index}>
                    <td>
                      ...
                      {/* <p className="mb-1 ct_text_op_6 d-flex align-items-center gap-2 mt-2">
                        <img  loading="lazy" src="../assets/img/bed_icon_1.svg" alt="" /> Last
                        Check-Out: 03 July – 08 July
                      </p>
                      <p className="mb-0 ct_text_op_6 d-flex align-items-center gap-2 mt-2">
                        <img  loading="lazy" src="../assets/img/user_icon_1.svg" alt="" />
                        Guest: John Doe
                      </p> */}
                    </td>
